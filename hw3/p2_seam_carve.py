...
if __name__ == '__main__':
    ...
    if cols>rows:
        ...
        print("{}, 0".format(C_first[0]))
        middle_index = int(np.round(C_first.shape[0]/2))
        print("{}, {}".format(C_first[middle_index],middle_index))
        last_index = C_first.shape[0]-1
        print("{}, {}".format(C_first[last_index],last_index))
        print("Energy of seam 0: {:.2f}".format(E_first))
        ...
        print("{}, 0".format(C_second[0]))
        middle_index = int(np.round(C_second.shape[0]/2))
        print("{}, {}".format(C_second[middle_index],middle_index))
        last_index = C_second.shape[0]-1
        print("{}, {}".format(C_second[last_index],last_index))
        print("Energy of seam 0: {:.2f}".format(E_Second))
        ...
        print("{}, 0".format(C_last[0]))
        middle_index = int(np.round(C_last.shape[0]/2))
        print("{}, {}".format(C_last[middle_index], middle_index))
        last_index = C_last.shape[0]-1
        print("{}, {}".format(C_last[last_index], last_index))
        print("Energy of seam 0: {:.2f}".format(E_Last))
    ...
    file_name_ext = args[1]
    file_extension = file_name_ext[-4:]
    filename = file_name_ext[:-4]
    new_file_name_s = filename + "_seam" + file_extension
    new_file_name_f = filename + "_final" + file_extension
    
    cv2.imwrite(new_file_name_s, first_seam)
    cv2.imwrite(new_file_name_f, final_image)
